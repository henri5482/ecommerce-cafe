    ...
    <div className="py-28 bg-slate-50">
      <div className="container mx-auto xl:w-[1300px] h-auto md:gap-20 flex flex-col lg:flex-row items-center justify-between px-4 md:px-16 lg:px-4 relative">
        <div className="flex-1 mb-8 lg:mb-0">
          <Image
            src="/promo.webp"
            alt="Combo Broaster con pollo broaster y gaseosa personal en Restaurante LUROMY"
            width={550}
            height={600}
        ...
        <div className="flex-1 max-w-lg mb-8 lg:mb-0">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 bebas-neue-regular text-gray-800">
            ¡Combo Broaster! Pollo Broaster + Gaseosa Personal
          </h1>
          <p className="text-base md:text-lg leading-relaxed py-4 text-gray-600 schibsted-grotesk font-semibold">
            ...
            Preparado con ingredientes de calidad para brindarte el sabor y la
            frescura que mereces. Haz que tu día sea especial con esta deliciosa
            combinación. ¡Ven y prueba el mejor broaster del Aeropuerto!
          </p>
          <div className="flex flex-col md:flex-row lg:justify-start justify-between items-center bebas-neue-regular">
            <Link
              ...
              aria-label="Pedir la promoción Combo Broaster"
              target="_blank"
            >
              Pedir promoción
            </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 text-center lg:px-20">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600">
            Solo zona del Aeropuerto <br /> entre 20 a 40 minutos
          </p>
        </div>
        <div className="flex flex-col items-center">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Restaurant",
            name: "Restaurante LUROMY",
            image: "https://luromy.vercel.app/promo.webp",
            address: {
              "@type": "PostalAddress",
              streetAddress: "Zona Aeropuerto",
              addressLocality: "Ayacucho",
              addressCountry: "PE",
            },
            telephone: "+51918237837",
            servesCuisine: "Comida Rápida, Pollo Broaster",
